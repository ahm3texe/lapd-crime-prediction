...
time_occ = st.number_input("Suç Saati (0-1 arası, normalize)", min_value=0.0, max_value=1.0, value=0.5)
vict_age = st.number_input("Mağdur Yaşı (0-1 arası, normalize)", min_value=0.0, max_value=1.0, value=0.5)
